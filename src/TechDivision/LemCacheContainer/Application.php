...
class Application extends AbstractApplication
{
    ...
    public function connect() {
        ...
        $queueManager = $this->newInstance('TechDivision\LemCache\QueueManager', array($this));
    ...
    public function locate($queue) {
        $queueLocator = $this->newInstance('TechDivision\LemCache\Service\Locator\QueueLocator', array($this->getQueueManager()));
